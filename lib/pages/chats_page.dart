  ...
  void _subscribe() {
    ...
    _dialogService.subscribe(
      ...
      onCreate: (dialog) {
        ...
        final exists = _dialogs.any((e) => e.id == dialog.id);
          ...
          setState(() {
            _dialogs = _dialogs.map((e) {
              if (e.id == dialog.id) {
                ...
                return DialogModel(
                  id: dialog.id,
                  otherUserId: dialog.otherUserId,
        ...
        actions: [
          IconButton(
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const CreateDialogPage()),
            ),
                    ...
                    itemBuilder: (context, i) {
                      ...
                      return ChatTile(
                        ...
                        onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => ChatPage(dialog: dialog),
                          ),
                        ),
                      );
                    },
